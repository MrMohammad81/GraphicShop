        ...
        <div class="header-cart-content flex-w js-pscroll">
            <ul class="header-cart-wrapitem w-full">
                ...
                <li class="header-cart-item flex-w flex-t m-b-12">
                    ...
                    <div class="header-cart-item-txt p-t-8">
                        <a href="{{ route('home.products.show' , $id) }}" class="header-cart-item-name m-b-18 hov-cl1 trans-04">
                            {{ $value['title'] }}
                        </a>
            ...
            <div class="w-full">
                <div class="header-cart-total w-full p-tb-40">
                    جمع کل: {{ number_format(array_sum(array_column(json_decode(\Illuminate\Support\Facades\Cookie::get('basket') , true) , 'price'))) }} هزار تومان
                </div>
